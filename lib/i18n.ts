...
const en = {
  ...
  categories: {
    ...
    names: {
      ...
      "specialty-seasonal": "Specialty & Seasonal",
    },
  },
  trust: {
...
export const dictionaries: Record<Locale, DictionaryShape> = {
  ...
  es: mergeDictionary({
    ...
    categories: { eyebrow: "Categorías", title: "Para cada trabajo hay un helper", body: "Categorías locales principales, con más a medida que crece cada mercado.", nearby: "cerca" },
  ...
  zh: mergeDictionary({
    ...
    categories: { title: "各种需求，都能找到 helper", nearby: "附近" },
  ...
  fr: mergeDictionary({
    ...
    categories: { title: "Quel que soit le besoin, il y a un helper", nearby: "proches" },
  ...
  ru: mergeDictionary({
    ...
    categories: { title: "Для любой задачи найдется исполнитель", nearby: "рядом" },
  ...
  te: mergeDictionary({
    ...
    categories: { eyebrow: "వర్గాలు", title: "ఏ పని అయినా, దానికి ఒక హెల్పర్ ఉన్నారు", body: "ప్రతి మార్కెట్ పెరుగుతున్న కొద్దీ మరిన్ని సేవలు జోడించబడే ప్రధాన స్థానిక సేవా వర్గాలు.", nearby: "సమీపంలో" },
  ...
  vi: mergeDictionary({
    ...
    categories: { eyebrow: "Danh mục", title: "Mọi công việc đều có người trợ giúp phù hợp", body: "Các nhóm dịch vụ địa phương chính, với nhiều dịch vụ mới được thêm khi thị trường phát triển.", nearby: "gần đây" },
  ...
  th: mergeDictionary({
    ...
    categories: { eyebrow: "หมวดหมู่", title: "ไม่ว่างานอะไร ก็มีผู้ช่วยที่เหมาะสม", body: "หมวดหมู่บริการหลักในพื้นที่ พร้อมเพิ่มบริการใหม่เมื่อแต่ละตลาดเติบโต", nearby: "ใกล้คุณ" },
