...
export const dictionaries: Record<Locale, DictionaryShape> = {
  ...
  ru: mergeDictionary({
    ...
    metaDescription: "Бронируйте helpers для уборки, ремонта, красоты, сада, переезда, питомцев, помощи пожилым, репетиторов и другого.",
    nav: { how: "Как работает", clients: "Для клиентов", pricing: "Цены", categories: "Категории", helpers: "Для Helpers", trust: "Безопасность", getApp: "Скачать app" },
    hero: { badge: "Запуск в вашем районе", before: "Найдите", highlight: "надежную локальную помощь", after: "рядом", body: "Бронируйте уборку, ремонт, красоту, сад, переезд, уход за питомцами и другое в одном marketplace.", findHelp: "Найти помощь", becomeHelper: "Стать Helper", bookingConfirmed: "Бронь подтверждена" },
    how: { eyebrow: "Как работает", title: "Помощь в три касания", body: "От нужна помощь до забронировано, без долгих звонков и мутных quotes." },
    steps: [["Найдите helpers рядом", "Смотрите надежных helpers на живой карте."], ["Сравните услуги и цены", "Изучайте профили, услуги и цены до брони."], ["Бронируйте, пишите и платите", "Чат, quote и оплата внутри приложения."]],
    helpers: { eyebrow: "Для Helpers", title: "Превратите навыки в локальный доход", body: "Настройте профиль и получайте заказы от соседей.", start: "Начать как Helper", earnings: "Доход за неделю", bookings: "3 новых брони", quotes: "2 quotes ждут ответа" },
    categories: { title: "Для любой задачи найдется helper", nearby: "рядом", names: { cleaning: "Уборка", handyman: "Handyman", plumbing: "Сантехника", electrical: "Электрика", "lawn-garden": "Сад и газон", "nails-beauty": "Красота", moving: "Переезд", "pet-care": "Питомцы", "senior-care": "Помощь пожилым", tutoring: "Репетиторы" } },
    ...
    waitlist: { title: "Скачайте SwapSpot сегодня", body: "Смотрите helpers бесплатно. Pass нужен, чтобы писать, запрашивать quotes или бронировать.", join: "Скачать app", storeCaption: "Доступно на iOS и Android" },
    download: { badge: "Уже доступно", title: "Скачайте SwapSpot для iOS или Android", body: "Смотрите helpers бесплатно. Pass нужен, чтобы писать, запрашивать quotes или бронировать.", pointA: "Для клиентов и helpers", pointB: "Бесплатный просмотр до контакта" },
    footer: { product: "Продукт", company: "Компания", contact: "Контакты", privacy: "Конфиденциальность", support: "Поддержка", accountDeletion: "Удаление аккаунта", terms: "Условия", pricingPayouts: "Цены и выплаты", bottom: "Найдите надежную локальную помощь рядом." },
  }),
  ar: mergeDictionary({
