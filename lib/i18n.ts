...
export const dictionaries = {
  ...
  es: {
    ...
    waitlist: { title: "¿Listo para encontrar ayuda a la vuelta?", body: "Descarga SwapSpot para ver helpers cercanos, enviar mensajes, pedir quotes y reservar.", email: "Correo electrónico", placeholder: "tu@email.com", join: "Descargar app", thanks: "Gracias — estás en la lista.", storeCaption: "Disponible ahora en iOS y Android", comingSoon: "Disponible en", noSpam: "Descarga la app, explora helpers y empieza cuando quieras." },
  ...
  zh: {
    ...
    waitlist: { title: "准备好寻找附近帮助了吗？", body: "下载 SwapSpot，浏览附近 helpers、发送消息、请求报价并预约。", email: "邮箱地址", placeholder: "you@email.com", join: "下载应用", thanks: "谢谢 — 你已加入列表。", storeCaption: "现已支持 iOS 和 Android", comingSoon: "可下载于", noSpam: "下载应用，先浏览 helpers，准备好后再开始。" },
  ...
  fr: {
    ...
    waitlist: { title: "Prêt à trouver de l’aide près de chez vous ?", body: "Téléchargez SwapSpot pour parcourir les helpers proches, envoyer des messages, demander des quotes et réserver.", email: "Adresse email", placeholder: "vous@email.com", join: "Télécharger l’app", thanks: "Merci — vous êtes sur la liste.", storeCaption: "Disponible maintenant sur iOS et Android", comingSoon: "Disponible sur", noSpam: "Téléchargez l’app, parcourez les helpers et commencez quand vous voulez." },
  ...
  ru: {
    ...
    waitlist: { title: "Готовы найти помощь рядом?", body: "Скачайте SwapSpot, чтобы смотреть helpers рядом, писать, запрашивать quotes и бронировать.", email: "Email", placeholder: "you@email.com", join: "Скачать app", thanks: "Спасибо — вы в списке.", storeCaption: "Уже доступно на iOS и Android", comingSoon: "Доступно в", noSpam: "Скачайте app, смотрите helpers и начинайте, когда готовы." },
